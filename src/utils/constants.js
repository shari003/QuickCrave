...
export const SWIGGY_API = (lat='28.5222633', lng='77.1722417') => {
...
export const SWIGGY_RES_MENU_API = (resId, lat='28.5204637', lng='77.17866599999999') => {
    return `https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=${lat}&lng=${lng}&restaurantId=${resId}&catalog_qa=undefined&submitAction=ENTER`;
}
